...
async fn main(spawner: Spawner) {
    ...
    // Optional extra GPS config steps are now gated and handled in comm::gps::configure_ublox.
    ...
    // Verbose GPS example moved to tasks::gps as a commented reference to keep main lean.
